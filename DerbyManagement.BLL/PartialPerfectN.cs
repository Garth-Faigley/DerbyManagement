...
namespace DerbyManagement.BLL
{
    class PartialPerfectN
    {
        ...
        public void Schedule()
        {
            ...
            // translated from the Javascript at http://www.stanpope.net/ppngen.html 
            ...
            //                       < p >
            //                       < b >
            //                       Partial Perfect - N(PPN) Charts are a concept expounded to me by Cory Young, under the name
            //< SCRIPT LANGUAGE = "JavaScript" >
            // < !--
            //  document.write('"');
            //                        WebLink("Enhanced Lane Rotation", CoryYoungSite + "methods.html", "");
            //                        document.write('."');
            //                        // --> </script>
            ...
            //< p >
            //< b >
            //If requested charts, scoresheets, etc. do not appear, make sure that you are not blocking pop-up windows. (Recent browser releases, e.g.Chrome, seem to block pop - ups more aggressively.)
            //</ b >
            ...
            //                   please check here < input type = "checkbox" Name = "diags" >, generate the chart again and send the contents of the PPNGEN DIAGNOSTIC OUTPUTS page to
            //                         < SCRIPT LANGUAGE = "JavaScript" >
            //                          < !--
            //                           EMailLink("Stan.", StanPope);
            //// --> </script>
            //</ b >
            ...
            //      < p >
            //      < b >
            //      If you are having trouble saving the page to your local disk or just want all of the pieces close at hand, here is a
            //      <SCRIPT LANGUAGE= "JavaScript" >
            //      < !--
            //       WebLink("45K zip file with versions current as of 3/21/2001.", StanPopeSite + "ppn.zip", "");
            //// --> </script>
            //</ b >
            ...
            //                        < BR > 3 / 11 / 2014: Possible issue with Chrome.
            //                        < BR > 11 / 20 / 2014: Chrome issue resolved.Don't block pop-ups!
            //                        < SCRIPT LANGUAGE = "JavaScript" >
            //                        < !--
            //                         EmailMe(1);
            //                        // --> </script><p>
            //                        Copyright 1998, 1999, 2000, 2001, 2004 & copy; by Stan Pope and
            //< SCRIPT LANGUAGE = "JavaScript" >
            // < !--
            //  EMailLink("Cory Young (" + CoryYoungEMail + ").", CoryYoungEMail);
            //                        // --> </script>
            ...
            //< SCRIPT LANGUAGE = "JavaScript" >
            //                     < !--
            //                      document.write(StanPopeSite + "ppngen.html");
            //// --> </script>
